...
<h1>Assign Role For {{$user->name}}</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="row form-group">
                <div class="col col-md-3">
                    <label class=" form-control-label" ><strong>Select Roles</strong></label>
                </div>
                    ...
                    <div class="form-check">
                        <div class="checkbox">
                            <label for="checkbox1" class="form-check-label ">
                                <input type="checkbox" id="checkbox1" name="roles[]" value="{{$role->id}}" class="form-check-input"
...
<div class="col-md-6">
    <h3>Assign Permissions For {{$user->name}}</h3>
                            ...
                            <div class="checkbox">
                                <label for="checkbox1" class="form-check-label ">
                                    <input type="checkbox" id="checkbox1" name="permissions[]" value="{{$permission->id}}" class="form-check-input"
                                           @if($user->permissions->pluck('id')->contains($permission->id)) checked @endif
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal"><a href="{{route('users.index')}}">  Cancel</a></button>
